...
# --- Inisialisasi Session State (Login dinonaktifkan) ---
def init_session_state():
    # Mengatur default agar langsung 'logged_in'
    defaults = {'page': 'home', 'username': 'Admin', 'role': 'admin'}
...
def show_main_dashboard():
    ...
    col1, col2 = st.columns([1.2, 5.5]) # Kolom disesuaikan karena tombol logout dihapus
    with col1:
...
# --- Router Utama Aplikasi (Login Dihilangkan) ---
def main():
...
# Catatan: Fungsi show_login_page() sengaja tidak dihapus agar mudah dikembalikan jika suatu saat dibutuhkan lagi.